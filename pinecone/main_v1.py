...
def search_pdf_content(query: str, index, namespace: str = "pdf-namespace", top_k: int = 5):
    ...
    if 'result' in results and 'hits' in results['result']:
        for i, hit in enumerate(results['result']['hits'], 1):
            ...
            print(f"   Text: {hit['fields']['chunk_text'][:200]}...")
    else:
...
def main():
    ...
    if not os.path.exists(pdf_path):
        ...
        print("Please make sure temp.pdf exists in the pinecone folder")
        return
    ...
    print("Type your questions about the PDF content.")
